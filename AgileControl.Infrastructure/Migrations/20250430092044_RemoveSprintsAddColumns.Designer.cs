...
namespace AgileControl.Infrastructure.Migrations
{
    ...
    [Migration("20250430092044_RemoveSprintsAddColumns")]
    partial class RemoveSprintsAddColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgileControl.Domain.Entities.KanbanColumn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AgileControl.Domain.Entities.ProjectTask", b =>
                {
                    ...
                    b.HasOne("AgileControl.Domain.Entities.KanbanColumn", "KanbanColumn")
                        .WithMany("Tasks")
