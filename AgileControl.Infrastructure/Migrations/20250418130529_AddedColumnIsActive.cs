    ...
    public partial class AddedColumnIsActive : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    PojectId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProjectRole = table.Column<int>(type: "integer", nullable: true),
                    UserId1 = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectMembers", x => new { x.UserId, x.PojectId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProjectMembers_Projects_PojectId",
                        column: x => x.PojectId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    StoryPoint = table.Column<int>(type: "integer", nullable: true, defaultValue: 0),
                    EndDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IdUserCreated = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectMembers_PojectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectTasks_IdUserCreated",
                table: "ProjectTasks",
